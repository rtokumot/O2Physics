...
struct myLambda {
  HistogramRegistry registry{
    ...
    {{"hReduction", "", {HistType::kTH1F, {{2, 0, 2}}}},
     ...
     {"hmyLambda_before", "", {HistType::kTH2F, {{250, 1.0, 1.25, "Lambda_mass"}, {10000, 0, 10, "pt"}}}},
     {"hmcLambda_before", "", {HistType::kTH2F, {{250, 1.0, 1.25, "Lambda_mass"}, {10000, 0, 10, "pt"}}}},
     {"hmyLambda_after", "", {HistType::kTH2F, {{250, 1.0, 1.25, "Lambda_mass"}, {10000, 0, 10, "pt"}}}},
     {"hmcLambda_after", "", {HistType::kTH2F, {{250, 1.0, 1.25, "Lambda_mass"}, {10000, 0, 10, "pt"}}}},
               ...
               DauTracks const& tracks, aod::McParticles const& mcParticles)
  {
    ...
    for (auto& v0 : V0s) {
      ...
      if ( // track cuts
        ...
        TMath::Abs(v0.mK0Short() - RecoDecay::getMassPDG(kK0Short)) > removeKs) {
...
struct myXi {
  HistogramRegistry registry{
    ...
    {{"hReduction", "", {HistType::kTH1F, {{2, 0, 2}}}},
     {"hReduction_mc", "", {HistType::kTH1F, {{2, 0, 2}}}},
     {"hmyXi_before", "", {HistType::kTH2F, {{500, 1.2, 1.7, "Xi_mass"}, {10000, 0, 10, "pt"}}}},
     {"hmcXi_before", "", {HistType::kTH2F, {{500, 1.2, 1.7, "Xi_mass"}, {10000, 0, 10, "pt"}}}},
               ...
               aod::McParticles const& mcParticles)
  {
    ...
    for (auto& casc : Cascades) {
      ...
      if ( // Dau & bach track cuts
        ...
        TMath::Abs(posdau.tpcNSigmaPr()) < tpcsigma && TMath::Abs(negdau.tpcNSigmaPi()) < tpcsigma && TMath::Abs(bachelor.tpcNSigmaPi()) < tpcsigma &&
        bachelor.sign() < 0 &&
        ...
        if (TMath::Abs(v0.mLambda() - RecoDecay::getMassPDG(kLambda0)) < v0masswindow &&
            ...
            TMath::Abs(casc.mOmega() - RecoDecay::getMassPDG(kOmegaMinus)) > removeOmega &&
            casc.sign() < 0) {
...
struct myOmega {
  HistogramRegistry registry{
    ...
    {{"hReduction", "", {HistType::kTH1F, {{2, 0, 2}}}},
     {"hReduction_mc", "", {HistType::kTH1F, {{2, 0, 2}}}},
     {"hmyOmega_before", "", {HistType::kTH2F, {{500, 1.5, 2.0, "Omega_mass"}, {10000, 0, 10, "pt"}}}},
     {"hmcOmega_before", "", {HistType::kTH2F, {{500, 1.5, 2.0, "Omega_mass"}, {10000, 0, 10, "pt"}}}},
     {"hmyLambda", "", {HistType::kTH1F, {{250, 1.0, 1.25}}}},
     {"hmyOmega_after", "", {HistType::kTH2F, {{500, 1.5, 2.0, "Omega_mass"}, {10000, 0, 10, "pt"}}}},
     {"hmcOmega_after", "", {HistType::kTH2F, {{500, 1.5, 2.0, "Omega_mass"}, {10000, 0, 10, "pt"}}}},
  ...
  using DauTracks = soa::Join<aod::Tracks, aod::TracksExtra, aod::pidTPCPi, aod::pidTPCPr, aod::pidTPCKa>;
               ...
               aod::McParticles const& mcParticles)
  {
    ...
    for (auto& casc : Cascades) {
      ...
      if ( // Dau & bach track cuts
        ...
        posdau.pt() > minpt && negdau.pt() > minpt && bachelor.pt() > minpt &&
        TMath::Abs(casc.dcapostopv()) > dcatopv && TMath::Abs(casc.dcanegtopv()) > dcatopv && TMath::Abs(casc.dcabachtopv()) > dcatopv &&
        TMath::Abs(posdau.tpcNSigmaPr()) < tpcsigma && TMath::Abs(negdau.tpcNSigmaPi()) < tpcsigma && TMath::Abs(bachelor.tpcNSigmaKa()) < tpcsigma &&
        bachelor.sign() < 0 &&
        ...
        if (TMath::Abs(v0.mLambda() - RecoDecay::getMassPDG(kLambda0)) < v0masswindow &&
            ...
            casc.dcacascdaughters() < dcacascdau &&
            casc.casccosPA(collision.posX(), collision.posY(), collision.posZ()) > casccospa &&
            TMath::Abs(casc.mXi() - RecoDecay::getMassPDG(kXiMinus)) > removeXi &&
            casc.sign() < 0) {
...
{
  return WorkflowSpec{
    adaptAnalysisTask<myLambda>(cfgc),
